  ...
  return (
    <>
      ...
      <form className="contact__form" onSubmit={sendEmail}>
        ...
        <label for="name" className="contact__form--label">Jméno a přijmení
        <input type="text" name="user__name" id="name" className="contact__form--input"/>
        </label>
        
        <label for="email" className="contact__form--label">E-mail
        <input type="email" name="user__email" id="email" className="contact__form--input"/>
        </label>
      
        <label for="subject" className="contact__form--label">Vaše zpráva
