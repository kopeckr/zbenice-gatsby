        ...
        <section className="introduction container">
          <div className="introduction__container">
            ...
            <p className="introduction__history">
              ...
              Janem a Albertem. Jan pak vlastní Zalužany a Albert kupuje roku
              1453 ves Laszko. Albert později získává od svého bratra Zalužany a
              od roku 1461 zastává úřad místopurkrabího na Karlštejně. Byl
              ženatý s Barborou, rozenou ze Všechlap, s kterou měl syna
              Mikuláše. Z dalších menších statků, které rod vlastnil, lze
              jmenovat např. Zbenice, Smolety, Suchou, Nedanice atd. Po porážce
              stavovského povstání na Bílé hoře roku 1620, je rod odsouzen ke
              ztrátě dvou třetin majetku. Poslední známý člen rodu Mikuláš Šic
              je připomínán roku 1650 v Drážďanech. Po tomto datu stopa tohoto
              rodu mizí.
            </p>
          </div>
        </section>
          ...
          <ul className="timeline__list">
            ...
            <li className="timeline__item">
              <p className="timeline__text">
                ...
                roku 1539 Jindřichu Opršalovi z Jetřichovic, který měl za
                manželku Dorotu z Bolu. Jindřich byl oddaným přívržencem Jiříka
                z Poděbrad a účastnil se po jeho boku mnoha bitev.
              </p>
            </li>
            <li className="timeline__item">
              <p className="timeline__text">
                ...
                dělení majetku dostává Zbenice Adam Bukovanský, který je roku
                1609 prodal Barboře Vlkové, rozené z Mitrovic. Po ní dědí Jan
                Vlk z Kvítkova / ženatý s Johankou Eusebií z Harasova /, který
                vše prodává Vilému Šléglovskému ze Sicendorfu, místopísaři
                království Českého.
              </p>
            </li>
            <li className="timeline__item">
              <p className="timeline__text">
                ...
                1626 starou tvrz přestavět na zámek v pozdně renesančním stylu s
                malým uzavřeným nádvořím. Po smrti Viléma Šléglovského se
                majetku ujímá jeho manželka Alena, rozená ze Střítěže, která se
                podruhé vdává za Jindřicha Bynu z Bynu. Posledním držitelem z
                tohoto rodu byla Bernarda Bynová, provdaná Čejková.
              </p>
            </li>
            <li className="timeline__item">
              <p className="timeline__text">
                <time className="timeline__year">1754</time> Její syn hrabě Jan
                Čejka z Olbramovic prodává Zbenice roku 1754 klášteru sv. Jana
                pod Skalou. Po zrušení kláštera roku 1785 kupuje, po dořešení
                majetkových převodů, roku 1791 zámek s dvorem Josef ze
                Salzburgu. Ten jej však již o tři roky později prodal Františku
                Schrenkovi.
              </p>
            </li>
            <li className="timeline__item">
            ...
            <li className="timeline__item">
              <p className="timeline__text">
                ...
                vyhořel. Po té byl provizorně zastřešen a nebyl dlouho využíván.
                V dobách kdy patřilo všechno všem zámek náleží JZD Chraštice,což
                se na něm značně podepsalo.
              </p>
            </li>
            <li className="timeline__item">
              <p className="timeline__text">
